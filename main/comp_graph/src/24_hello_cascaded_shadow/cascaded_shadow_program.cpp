...
Camera2D HelloCascadedShadowProgram::CalculateOrthoLight(float cascadeNear, float cascadeFar, Vec3f lightDir) const
{
    ...
    {
        // near face
        camera.position- camera.reverseDirection * cascadeNear +camera.rightDirection *nearX+camera.upDirection*nearY,
        camera.position- camera.reverseDirection * cascadeNear -camera.rightDirection *nearX+camera.upDirection *nearY,
        camera.position- camera.reverseDirection * cascadeNear +camera.rightDirection *nearX-camera.upDirection *nearY,
        camera.position- camera.reverseDirection * cascadeNear -camera.rightDirection *nearX-camera.upDirection *nearY,

        camera.position- camera.reverseDirection * cascadeFar +camera.rightDirection *farX+camera.upDirection *farY,
        camera.position- camera.reverseDirection * cascadeFar -camera.rightDirection *farX+camera.upDirection *farY,
        camera.position- camera.reverseDirection * cascadeFar +camera.rightDirection *farX-camera.upDirection *farY,
        camera.position- camera.reverseDirection * cascadeFar -camera.rightDirection*farX-camera.upDirection *farY,
    };
